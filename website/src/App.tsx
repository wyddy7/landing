  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white flex flex-col">
      ...
      <footer className="fixed bottom-0 left-0 right-0 sm:relative sm:bottom-auto sm:left-auto sm:right-auto bg-[#050505] border-t border-[#1F1F1F] px-5 py-4 sm:px-6 sm:py-6 flex-shrink-0 z-10">
        <div className="max-w-4xl mx-auto">
          <div className="font-mono text-base sm:text-base text-[#A1A1AA] flex flex-wrap items-center gap-3 sm:gap-0">
            ...
            <div className="flex items-center gap-3 sm:gap-0">
              <a
                ...
                className="text-white hover:text-[#CCFF00] transition-colors duration-200 inline-flex items-center ml-0 sm:ml-2"
              >
                <Github className="h-6 w-6 sm:h-5 sm:w-5" />
              </a>
              <a
                href="mailto:your-email@example.com"
                className="text-white hover:text-[#CCFF00] transition-colors duration-200 inline-flex items-center ml-0 sm:ml-4"
              >
              ...
              <Button
                ...
                rel="noopener noreferrer"
                variant="solid"
                className="ml-0 sm:ml-4 inline-flex items-center gap-2 font-bold text-base"
              >
