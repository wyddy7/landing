...
const buttonVariants = cva(
    "relative group border text-foreground mx-auto text-center rounded-full font-mono",
    {
        variants: {
            variant: {
                default: "bg-[#050505] hover:bg-[#050505]/80 border-[#CCFF00]/20 hover:border-[#CCFF00]/40 text-white hover:text-[#CCFF00]",
                solid: "bg-[#CCFF00] hover:bg-[#B8E600] text-black border-transparent hover:border-foreground/50 transition-all duration-200",
