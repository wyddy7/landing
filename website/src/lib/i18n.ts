    ...
    cards: [
      {
        ...
        description: "Проектирование автономных ИИ-агентов и масштабируемых контент-пайплайнов. Специализируюсь на создании готовых к продакшену систем, которые быстро решают задачи бизнеса.",
      },
      {
        id: "2",
        title: "Бэкграунд",
      ...
      {
        id: "3",
        title: "Платформа автоматизации видео (Основатель и Lead)",
